...
/**
 * Parses a Figma design URL and extracts the file ID.
 * Supports branch URLs (returns the branch ID instead).
 *
 * @param name - A label for error messages (e.g. the config key name)
 * @param figmaURL - The Figma URL to parse
 * @returns The file ID or branch ID, or undefined if the URL is empty
 */
