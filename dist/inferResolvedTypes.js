...
export function inferResolvedTypes(centralTokens, fileVariables) {
    ...
    const resolveVariableTypes = (collectionName, variableName) => {
        ...
        for (const mode in variable) {
            ...
            const resolvedType = determineResolvedTypeWithAlias(typedCentralTokens, value, fileVariables);
